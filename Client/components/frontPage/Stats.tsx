    ...
    <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8">
      <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
        ...
        <p className="mt-6 text-lg leading-8 text-gray-300">
          With a proven track record of delivering reliable and innovative
          solutions, our SaaS platform has empowered thousands of developers and
          teams to code, compile, and collaborate efficiently.
        </p>
      </div>
